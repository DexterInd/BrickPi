...
/*  if(Result != (-2)){
  ...
  if(Result == 1){	 	//1  Destination address was mine
  ...
  // If nothing important was received, go ahead and check the timeout situation.  Have we timed out since last communication?
  // If we haven't, update the motor PWM.  
